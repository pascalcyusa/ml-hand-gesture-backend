    ...
    "inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium transition-all duration-200 cursor-pointer select-none disabled:opacity-40 disabled:cursor-not-allowed disabled:pointer-events-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--green)]/40 focus-visible:ring-offset-1 focus-visible:ring-offset-[var(--bg)]",
    {
        variants: {
            variant: {
                ...
                primary:
                    "bg-[var(--green-dim)] text-[var(--bg-hard)] rounded-md border border-[var(--green)]/30 hover:bg-[var(--green)] hover:shadow-[0_0_24px_rgba(184,187,38,0.25)] active:scale-[0.97]",
                danger:
                    "bg-[var(--red-dim)]/80 text-[var(--fg)] rounded-md border border-[var(--red)]/25 hover:bg-[var(--red)] hover:shadow-[0_0_24px_rgba(251,73,52,0.2)] active:scale-[0.97]",
                accent:
                    "bg-[var(--orange-dim)] text-[var(--bg-hard)] rounded-md border border-[var(--orange)]/30 hover:bg-[var(--orange)] hover:shadow-[0_0_24px_rgba(254,128,25,0.25)] active:scale-[0.97]",
                ghost:
                ...
                outline:
                    "bg-transparent text-[var(--fg-dim)] rounded-md border border-[var(--bg3)]/60 hover:bg-[var(--bg1)]/40 hover:border-[var(--bg4)]/60 hover:text-[var(--fg)] active:scale-[0.97]",
            },
            size: {
