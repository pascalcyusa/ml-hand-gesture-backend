    ...
    <div className="training-controls-container">
      ...
      <div className="control-panel">
        ...
        <div className="panel-header">
          ...
          <div
            className={`status-indicator ${isTrained ? "ready" : ""}`}
            title={isTrained ? "Model Ready" : "Untrained"}
          />
        </div>
        ...
        <div className="stats-row">
          ...
          <div
            className="stat-pill"
            style={{ color: isTrained ? "var(--primary)" : "var(--fg-muted)" }}
          >
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <Card className="w-full max-w-sm p-6 shadow-2xl border border-[var(--bg2)] bg-[var(--bg1)] space-y-4 rounded-2xl">
              ...
              <div className="flex justify-end gap-2 mt-4">
                ...
                <Button variant="primary" onClick={handleConfirmAddClass}>
                  Add Class
                </Button>
              </div>
            </Card>
            ...
            <Card className="w-full max-w-sm p-6 shadow-2xl border border-[var(--bg2)] bg-[var(--bg1)] space-y-4 rounded-2xl">
              <div className="flex flex-col gap-3">
                ...
                <p className="text-sm text-[var(--fg-muted)] leading-relaxed">
                  This will delete all current gesture classes and samples.{" "}
                  <br />
